document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll('#main-nav a[href^="#"], .hero-buttons a[href^="#"], .btn[href^="#"]').forEach(anchor => {
    ...
    // ==========================================================================
    // DATA IDM TABLE & SDGS (Hanya merender jika ID elemen bersangkutan ada)
    // ==========================================================================
    const tableBody = document.querySelector("#idm-table-body tbody");
    if(tableBody) {
        // Logika merender tabel IDM (Sudah aman, tidak akan error bila element tidak ada)
    }

    if (document.getElementById("sdgs-grid")) {
        // Logika merender SDG (Sudah aman)
    }
